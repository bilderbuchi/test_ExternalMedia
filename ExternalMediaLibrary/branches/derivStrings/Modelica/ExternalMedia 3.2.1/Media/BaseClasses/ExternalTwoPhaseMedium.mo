...
*/
  ...
  annotation (__Dymola_DymolaStoredErrors(thetext="package ExternalTwoPhaseMedium 
...
*/
  ...
  algorithm 
    ...
    /*  // If special definition in \"C\"
  external \"C\" kappa=  TwoPhaseMedium_isothermalCompressibility_C_impl(state, mediumName, libraryName, substanceName)
    annotation(Include=\"#include \\\"externalmedialib.h\\\"\", Library=\"ExternalMediaLib\", IncludeDirectory=\"modelica://ExternalMedia/Resources/Include\", LibraryDirect"
           + "ory=\"modelica://ExternalMedia/Resources/Library\");
*/
    annotation(Inline = true);
  end isothermalCompressibility;
...
*/
  ...
  algorithm 
    ...
    /*  // If special definition in \"C\"
  external \"C\" ddvdp=  TwoPhaseMedium_dDewDensity_dPressure_C_impl(sat, mediumName, libraryName, substanceName)
    annotation(Include=\"#include \\\"externalmedialib.h\\\"\", Library=\"ExternalMediaLib\", IncludeDirectory=\"modelica://ExternalMedia/Resources/Include\", LibraryDirectory=\"modelica://ExternalMedia/Resources/"
           + "Library\");
*/
    annotation(Inline = true);
  end dDewDensity_dPressure;
