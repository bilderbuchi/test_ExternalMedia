...
function setState_pTx "Return thermodynamic state record from p, T and x"
...
external "C" TwoPhaseMixture_setState_pTx_(p, T, phase, nComp, X, uniqueID, state.uniqueID, state.phase, state.d, state.h, state.p, state.s, state.T,
